...
class ProgressView: UIView {
    ...
    func animateProgressView(totalBytesWritten:CGFloat,totalBytesExpectedToWrite:CGFloat) {
        ...
        animation.duration = Double(totalBytesExpectedToWrite / totalBytesWritten)
